...
from vec2.account.service import account as account_service
from vec2.authz.service import AccessType, Authz
from vec2.exceptions import Vec2Error
from vec2.kit.services import ResourceService
from vec2.logging import Logger
from vec2.models import OAuthAccount, User
from vec2.models.user import OAuthPlatform
from vec2.postgres import AsyncSession, sql
from vec2.user.schemas.user import UserSignupAttribution
from vec2.worker import enqueue_job
