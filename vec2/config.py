...
from vec2.kit.jwk import JWKSFile
...
env = Environment(os.getenv("VEC2_ENV", Environment.development))
...
class Settings(BaseSettings):
    ...
    CURRENT_JWK_KID: str = "vec2_dev"
    WWW_AUTHENTICATE_REALM: str = "vec2"
    ...
    USER_SESSION_COOKIE_KEY: str = "vec2_session"
    ...
    # Database
    POSTGRES_USER: str = "vec2"
    POSTGRES_PWD: str = "vec2"
    POSTGRES_HOST: str = "127.0.0.1"
    POSTGRES_PORT: int = 5432
    POSTGRES_DATABASE: str = "vec2_development"
    ...
    STRIPE_STATEMENT_DESCRIPTOR: str = "VEC2"
    ...
    FAVICON_URL: str = "https://raw.githubusercontent.com/vec2source/vec2/2648cf7472b5128704a097cd1eb3ae5f1dd847e5/docs/docs/assets/favicon.png"
    THUMBNAIL_URL: str = "https://raw.githubusercontent.com/vec2source/vec2/4fd899222e200ca70982f437039f549b7a822ecc/clients/apps/web/public/email-logo-dark.png"
    ...
    # AWS (File Downloads)
    AWS_ACCESS_KEY_ID: str = "vec2-development"
    AWS_SECRET_ACCESS_KEY: str = "vec2123456789"
    AWS_REGION: str = "us-east-2"
    AWS_SIGNATURE_VERSION: str = "v4"

    # Downloadable files
    S3_FILES_BUCKET_NAME: str = "vec2-s3"
    S3_FILES_PUBLIC_BUCKET_NAME: str = "vec2-s3-public"
